...
/**
 * This is the main class for the model, where the game, practice and question
...
public class ModelMain {
    ...
    /**
     * Used to get a category for the game module.
     * 
     * @return String the category to be displayed to the user
     */
    public List<Category> getCategories() {
        List<Category> categories = _gameModel.getGameCategories();

        return categories;
    }

    /**
     * Used to get a question for either the game or practice module, depending on
     * the inputs.
     * 
    ...
    public String getQuestion() {
        ...
        questionModel.setCategory(new Category("Flora"));
